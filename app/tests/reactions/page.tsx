// app/tests/dependencies/page.tsx
'use client'
...
const subTests = [
    {
        id: 'member-tests',
        name: 'Member Tests',
        description: 'Tests chemicals as members with different catalysts',
        component: dynamic(() => import('./member-tests'), {
            loading: () => <TestLoading />,
            ssr: false
        })
    },
    {
        id: 'sharing-tests',
        name: 'Sharing Dependency Tests',
        description: 'Tests catalyst creation and parent reassignment',
        component: dynamic(() => import('./sharing-tests'), {
            loading: () => <TestLoading />,
            ssr: false
        })
    },
...
export default function DependenciesTest() {
                ...
                <div style={{ 
                    ...
                    <div style={{ textAlign: 'center' }}>
                        <h2 style={{ color: '#333', marginBottom: '20px' }}>
                            Reaction & Catalyst Test Suite
                        </h2>
                        <p style={{ marginBottom: '10px' }}>
                            Select a test from the tabs above to begin
                        </p>
                        <p style={{ fontSize: '14px', color: '#999' }}>
                            These tests demonstrate how Chemistry handles dependencies by managing their reactions
                        </p>
                    </div>
                </div>
            )}
