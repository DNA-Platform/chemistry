...
export const $rolesmap$ = Symbol("$ObjectiveRep.rolesmap");
...
export const $roleof$ = Symbol("$ObjectiveRep.roleof");
...
export const $membersOwn$ = Symbol("$ObjectiveRep.membersOwn");
export const $membersMap$ = Symbol("$ObjectiveRep.membersMap");
export const $membersOwnMap$ = Symbol("$ObjectiveRep.membersOwnMap");
export const $$primitives$$ = Symbol("$ObjectiveRep.primitives");
export const $$$primitives$$$ = Symbol("$ObjectiveRep.primitives");
