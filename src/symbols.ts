...
export const $properties$ = Symbol("$ObjectiveRep.properties");
export const $propertiesOwn$ = Symbol("$ObjectiveRep.propertiesOwn");
export const $propertiesMap$ = Symbol("$ObjectiveRep.propertiesMap");
export const $propertiesOwnMap$ = Symbol("$ObjectiveRep.propertiesOwnMap");
